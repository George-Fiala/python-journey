...
def analyze_numbers(numbers):
    ...
    return total_sum, count, frequency, max_value, min_value, average
...
def main():
    ...
    total_sum, count, freq, max_value, min_value, average = analyze_numbers(data)
    ...
    if idx is None:
        print(f"Number {search_num} its not in data.")
    else:
        print(f"Number {search_num} has index: {idx}.")
